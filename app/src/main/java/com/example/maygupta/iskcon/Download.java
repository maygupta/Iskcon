    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        btnPlayMusic.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                File file = new File(Download.this.getFilesDir()+"/iskcon"+"/iskcon.mp3");
...
//                File sdCard = Environment.getExternalStorageDirectory();
                //String sdCard = Download.this.getFilesDir();
                File directory = new File(Download.this.getFilesDir()+dirName);
                ...
                File outFile = new File(directory,"iskcon.mp3");
